...
namespace TestEngine.Models
{
    ...
    public class TestInventory
    {
        ...
        public void Test_AddItemQuantities()
        {
            ...
            Assert.AreEqual(3, inventory_1.Items.Count(i => i.ItemTypeID == 1001));
            Inventory inventory_2 =
                inventory_1.AddItemFromFactory(1001);
            Assert.AreEqual(4, inventory_2.Items.Count(i => i.ItemTypeID == 1001));
            Inventory inventory_3 =
                inventory_2.AddItems(new List<ItemQuantity> { new ItemQuantity(1002, 1) });
            Assert.AreEqual(4, inventory_3.Items.Count(i => i.ItemTypeID == 1001));
            Assert.AreEqual(1, inventory_3.Items.Count(i => i.ItemTypeID == 1002));
        }
        [TestMethod]
